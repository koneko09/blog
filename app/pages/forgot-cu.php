  ...
  <div class="login-form">
      ...
      <a href="<?php echo ROOT ?>/home">
       ...
       <div id="passwordFields" style="display: <?= isset($showPasswordFields) && $showPasswordFields ? 'block' : 'none' ?>;">
            ...
            <div class="form-group">    
              <input value="<?=old_value('rePassword')?>" type="password" name="rePassword" class="form-control" id="floatingPassword" placeholder="Mật khẩu">
          </div>
       </div>
        ...
        <div class="form-group">
              ...
              </div><p class="mt-5 mb-3 text-muted"> <?php echo  date("Y") ?></p>
      </form>
  </div class="login-form">
</main>
</body>
